# Pizzería The Tavern: Green Hill
## Sumario
...
|Se implementa algún tipo de búsqueda para determinar la 
|orden a eliminar (nombre del cliente, id de la orden, etc.) | --- |---| --- | --- | --- |
...
|Descripción |	Excelente | Muy bueno |	Bueno |	Regular |	Malo |
| --- | --- | --- | --- | --- | --- |
|Se calcula el total de ventas con las órdenes despachadas 
|únicamente, tanto a domicilio como en restaurante	| --- | --- | --- | --- | --- |				
...
# Apreciaciones
 1. ¿Qué aprendí con la realización de este proyecto?
...
2. ¿Qué fue lo más difícil de implementar?
...
3. ¿Qué fue lo más fácil de implementar?
...
4. ¿Qué cambiaría en el desempeño del catedrático?
...
5. ¿Qué cambiaría en el desempeño del instructor?
